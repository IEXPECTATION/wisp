...
export type Context = ListContext | ListItemContext | BlockQuoteContext | ThematicBreakContext | HeadingContext | IndentedCodeContext | FencedCodeContext | HtmlBlockContext | LinkReferenceDefinitionContext | ParagraphContext;
